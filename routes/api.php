...
Route::get('/sitemap/products-1.xml', [SitemapController::class, 'getProductsSitemap1']);
Route::get('/sitemap/products-2.xml', [SitemapController::class, 'getProductsSitemap2']);
Route::get('/sitemap/products-3.xml', [SitemapController::class, 'getProductsSitemap3']);
Route::get('/sitemap/products-4.xml', [SitemapController::class, 'getProductsSitemap4']);
Route::get('/sitemap/products-5.xml', [SitemapController::class, 'getProductsSitemap5']);
Route::get('/sitemap/products-6.xml', [SitemapController::class, 'getProductsSitemap6']);
Route::get('/sitemap/products-7.xml', [SitemapController::class, 'getProductsSitemap7']);
Route::get('/sitemap/products-8.xml', [SitemapController::class, 'getProductsSitemap8']);
Route::get('/sitemap/products-9.xml', [SitemapController::class, 'getProductsSitemap9']);
Route::get('/sitemap/products-10.xml', [SitemapController::class, 'getProductsSitemap10']);
