					...
					<td style="width: 48%; vertical-align: top;">
						<table
							...
							<tr style="background-color: #e5e7eb; text-align: center;">
								...
								<td style="border: 1px solid black; padding: 0.5rem; font-weight: 700;">Quotation No
								</td>
							</tr>
		...
		if (productCount <= 2) {
			root.innerHTML = `
				<div id="targetDiv" style=" ">
					<div class="min-height: 1150px; height: 1150px;  padding: 50px; box-sizing: border-box;background-color: white;">
						<div class="page">
							${renderHeader()}
							${renderHero()}
