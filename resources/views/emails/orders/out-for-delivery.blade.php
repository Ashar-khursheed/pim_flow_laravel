...
<body style="margin: 0; padding: 0; background: #ffffff; font-family: 'Noto Sans', sans-serif;">
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #f8f8f8;">
		<tr>
			<td align="center">
				<table class="container" width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; border: 1px solid #eaeaea;">
					<tr>
							...
							<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin: 20px 0;">
								<tr>
									<td valign="top" width="50%" style="padding: 0; padding-right: 10px;">
										<p style="font-weight: bold; font-size: 15px; color: #26683A; margin: 0 0 10px 0; font-family: 'Noto Sans', sans-serif;">Order Summary</p>
										<p style="font-size: 14px; font-weight: 600; color: #3F3F3F; margin: 0 0 5px 0; font-family: 'Noto Sans', sans-serif;">Carrier:<strong style="font-weight: 500;"> {{ $carrier }}</strong></p>
										<p style="font-size: 14px; font-weight: 600; color: #3F3F3F; margin: 0 0 5px 0; font-family: 'Noto Sans', sans-serif;">Order Number:<strong style="font-weight: 500;"> {{ $orderNumber }}</strong></p>
										<p style="font-size: 14px; font-weight: 600; color: #3F3F3F; margin: 0 0 5px 0; font-family: 'Noto Sans', sans-serif;">Arriving:<strong style="font-weight: 500;"> {{ $estimatedDeliveryFormatted }}</strong></p>
										<p style="font-size: 14px; font-weight: 600; color: #3F3F3F; margin: 0; font-family: 'Noto Sans', sans-serif;">Payment Method:<strong style="font-weight: 500;"> {{ $paymentMethod }}</strong></p>
									</td>
									<td valign="top" width="50%" style="padding: 0; padding-left: 10px; border-left:1px solid  #26683A;">
										<p style="font-weight: bold; font-size: 15px; color: #26683A; margin: 0 0 10px 0; font-family: 'Noto Sans', sans-serif;">Delivering to our valued customer</p>
										<p style="font-size: 14px; color: #3F3F3F; margin: 0 0 5px 0; font-family: 'Noto Sans', sans-serif;"><strong>{{ $name }}</strong></p>
										<p style="font-size: 14px; color: #26683A; margin: 0 0 5px 0; font-family: 'Noto Sans', sans-serif;">{{ $address }}</p>
										<p style="font-size: 14px; color: #26683A; margin: 0 0 5px 0; font-family: 'Noto Sans', sans-serif;">{{ $city }}</p>
										<p style="font-size: 14px; color: #26683A; margin: 0; font-family: 'Noto Sans', sans-serif;">{{ $country }}, {{ $zipcode }}</p>
									</td>
								</tr>
							</table>
				...
				<table class="footer-note" width="600" cellpadding="20" cellspacing="0" border="0" style="border-top: 3px solid #E2E8F0; background-color: rgba(226,232,240,0.3); font-size: 12px; color: #3F3F3F;">
					<tr>
