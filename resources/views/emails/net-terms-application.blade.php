...
<head>
	<meta charset="UTF-8" />
	<title>Your Net Terms Application Has Been Submitted</title>
				...
				<table class="container" width="650" cellspacing="0" cellpadding="10" border="0" style="background:#ffffff; border:1px solid #eaeaea; font-family: 'Noto Sans', sans-serif;">
					...
					<tr>
						<td>
							...
							<p style="font-size:14px; line-height:22px; font-family: 'Noto Sans', sans-serif; padding: 0; margin: 5px 0;">
								We've received your request, and our team has already started reviewing it.
							</p>
						</td>
					</tr>
							...
							<table cellspacing="0" cellpadding="0" border="0" style="width: 100%;">
								<tr>
									<td style="vertical-align: top; padding: 5px 0;">
										<span style="color: #26683A; font-size: 16px; margin-right: 8px;">✓</span>
									</td>
									<td style="padding: 5px 0;">
										<span style="font-size:14px; line-height:22px; font-family: 'Noto Sans', sans-serif; color: #1e3a2b;">
											We do <strong>NOT</strong> run any soft or hard credit checks on your application.
										</span>
									</td>
								</tr>
								<tr>
									...
									<td style="padding: 5px 0;">
										<span style="font-size:14px; line-height:22px; font-family: 'Noto Sans', sans-serif; color: #1e3a2b;">
											Your information is handled through our trusted, secure credit partner using encrypted, industry-grade protection.
										</span>
									</td>
								</tr>
							</table>
					...
					<tr>
						<td style="padding-top: 15px;">
							...
							<p style="font-size:14px; line-height:22px; font-weight: 600; font-family: 'Noto Sans', sans-serif; padding: 0; margin: 5px 0; color: #26683A;">
								Make it easier, faster, and stress-free so you can focus on running your restaurant.
							</p>
						</td>
					</tr>
					...
					<tr>
						<td style="padding-top: 20px;">
							...
							<p style="font-size:14px; line-height:22px; color: #26683A; font-weight: 600; font-family: 'Noto Sans', sans-serif; margin: 5px 0;">
								– Team HorecaStore
							</p>
						</td>
					</tr>
