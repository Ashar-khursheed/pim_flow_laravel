...
<head>
	<meta charset="UTF-8" />
	<title>Update on Your Net Payment Terms Application</title>
...
<body style="margin: 0; padding: 0; background: #ffffff; font-family: 'Noto Sans', sans-serif; color: #232425;">
	<span style="display: none; font-size: 1px; color: #ffffff; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">
		Update on your Net Payment Terms application - Let's explore next steps together.
	</span>
		...
		<tr>
			<td align="center" style="padding: 20px; font-family: 'Noto Sans', sans-serif;">
				<table class="container" width="600" cellspacing="0" cellpadding="0" border="0" style="border:1px solid #eaeaea; font-family: 'Noto Sans', sans-serif;">
					...
					<!-- What Can You Do Next Section -->
					<tr>
						<td style="padding: 10px 20px; font-size: 14px; font-family: 'Noto Sans', sans-serif;">
							<p style="font-weight: bold; margin: 0; padding: 5px 0; font-family: 'Noto Sans', sans-serif; font-size: 15px;">
								What can you do next?
							</p>
							<p style="margin: 0; padding: 5px 0; font-size: 14px; font-family: 'Noto Sans', sans-serif;">
								We understand this may be disappointing, but our team is here to help you understand what's needed for reconsideration and explore other options to support your business.
							</p>
						</td>
					</tr>
					...
					<tr>
						<td style="padding: 10px 20px; font-size: 14px; font-family: 'Noto Sans', sans-serif;">
							...
							<table cellspacing="0" cellpadding="0" border="0" style="width: 100%; font-family: 'Noto Sans', sans-serif; margin-top: 8px;">
								<tr>
					...
					<tr>
						<td style="padding: 10px 20px; font-size: 14px; font-family: 'Noto Sans', sans-serif;">
							<p style="font-weight: bold; margin: 0; padding: 5px 0; font-family: 'Noto Sans', sans-serif;">
								We can discuss:
							</p>
								...
								<tr>
									<td valign="top" style="padding: 5px 0; font-family: 'Noto Sans', sans-serif;">
										...
										<span style="color:#232425; margin-left: 8px; font-family: 'Noto Sans', sans-serif; font-size: 14px;">
											What additional information might help with approval
										</span>
									</td>
								</tr>
								<tr>
									<td valign="top" style="padding: 5px 0; font-family: 'Noto Sans', sans-serif;">
										<span style="color: #26683A; font-size: 16px; vertical-align: middle;">✓</span>
										<span style="color:#232425; margin-left: 8px; font-family: 'Noto Sans', sans-serif; font-size: 14px;">
											Alternative payment options for your orders
										</span>
									</td>
								</tr>
								<tr>
					...
					<tr>
						<td style="padding: 10px 20px; font-size: 14px; font-family: 'Noto Sans', sans-serif;">
							<p style="font-weight: 500; line-height: 24px; margin: 0; padding: 5px 0; font-family: 'Noto Sans', sans-serif; font-size:14px;">
								We value your business and are committed to supporting your growth. Let's work together to find the best way forward.
							</p>
							<p style="color: #232425; font-weight: 500; margin: 0; padding: 5px 0; font-family: 'Noto Sans', sans-serif; font-size:14px;">
								– Team HorecaStore
							</p>
						</td>
					</tr>
