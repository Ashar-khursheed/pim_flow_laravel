 ...
 *     tags={"NoFraud"},
 *     security={{"bearerAuth":{}}},
 *     summary="Screen transaction with NoFraud API",
 *     description="Send billing, shipping, and card details to the NoFraud API to screen for fraud. Stores and returns the decision.",
 *     @OA\RequestBody(
 *         required=true,
 *         @OA\JsonContent(
 *             required={
 ...
 *             @OA\Property(property="shipping_address", type="string", example="456 Another St"),
 *             @OA\Property(property="shipping_city", type="string", example="Los Angeles"),
 *             @OA\Property(property="shipping_state", type="string", example="CA"),
 *             @OA\Property(property="shipping_zip", type="string", example="90001"),
 ...
 *                 @OA\Property(property="risk_score", type="number", example=12.3),
 *                 @OA\Property(property="details", type="string", example="No fraud detected")
 *             )
 *         )
 *     ),
 *     @OA\Response(
  ...
  public function screenTransaction(Request $request)
{
    ...
    $response = Http::withHeaders([
        ...
        'nf-token' => env('NOFRAUD_API_KEY'), // ✅ Correctly moved to headers
