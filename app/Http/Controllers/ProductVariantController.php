...
class ProductVariantController extends Controller
{
    ...
    public function index_old(Request $request)
    {
        ...
        $recordsQuery = ProductVariant::with(['product:id,name,sku', 'attribute:id,name']);


        // Searchable columns should point to relations, not local columns
        $searchableColumns = ['ec_products.name', 'ec_products.sku', 'attributes.name'];
        $sortableColumns = array_merge($searchableColumns, ['product_variants.created_at', 'product_variants.updated_at']);
        ...
        // Join for searching
        $recordsQuery->leftJoin('ec_products', 'product_variants.parent_id', '=', 'ec_products.id')
            ->leftJoin('attributes', 'product_variants.attribute_id', '=', 'attributes.id');
        ...
        // Select consistent columns (renamed for clarity)
        $recordsQuery->addSelect([
