...
class PaymentController extends Controller
{
	 ...
	 *                 example="Credit Card",
	 *                 enum={"Credit Card", "Debit Card", "PayPal", "Bank Transfer", "Cash", "Stripe", "Razorpay","Paymob"}
	 *             ),
	 *             @OA\Property(
	 *                 property="amount",
	 *                 type="number",
	...
	public function store(Request $request)
	{
		try {
			$validated = $request->validate([
				...
				'payment_mode' => 'required|string|in:Credit Card,Debit Card,PayPal,Bank Transfer,Cash on Delivery,Stripe,Razorpay,Paymob',
