...
class InquiryController extends Controller
{
	 ...
	 * @OA\Get(
	 *     path="/api/inquiries",
	 *     summary="Get all inquiries with pagination and filters",
	 *     tags={"Inquiries"},
	 ...
	 *     @OA\Parameter(name="sort_by", in="query", description="Column name to sort by", @OA\Schema(type="string", enum={"id", "full_name", "phone", "email", "company_name", "lead_type", "lead_source", "created_at", "updated_at"})),
