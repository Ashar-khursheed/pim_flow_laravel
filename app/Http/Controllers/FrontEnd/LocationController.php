...
class LocationController extends Controller
{
     ...
     *     summary="Get location information based on IP address",
     *     tags={"Frontend-Location"},
     *     @OA\Parameter(
     *         name="ip",
     *         in="query",
     *         description="IP address to lookup (optional). If omitted, uses client IP.",
     *         required=false,
     *         @OA\Schema(type="string", example="8.8.8.8")
     *     ),
     *     @OA\Response(
     *         response=200,
    ...
    /**
     * @OA\Get(
     *     path="/frontend/get-coordinates",
     *     summary="Get geographic coordinates for a given address",
     *     tags={"Frontend-Location"},
     *     @OA\Parameter(
     *         name="address",
     *         in="query",
     *         required=true,
     *         description="The full address to convert to coordinates",
     *         @OA\Schema(type="string", example="1600 Amphitheatre Parkway, Mountain View, CA")
     *     ),
     *     @OA\Response(
     *         response=200,
     ...
     *                 @OA\Property(property="lat", type="number", example=37.422),
     *                 @OA\Property(property="lng", type="number", example=-122.084)
     *             )
     *         )
     *     ),
     *     @OA\Response(
    ...
    /**
     * @OA\Post(
     *     path="/frontend/realtime-location",
     *     summary="Get address from real-time coordinates using Google Maps",
     *     tags={"Frontend-Location"},
     *     @OA\RequestBody(
     *         required=true,
     *         @OA\JsonContent(
     *             required={"latitude","longitude"},
     *             @OA\Property(property="latitude", type="number", example=37.422),
     *             @OA\Property(property="longitude", type="number", example=-122.084)
     *         )
     *     ),
     *     @OA\Response(
     *         response=200,
     ...
     *         @OA\JsonContent(
     *             @OA\Property(property="address", type="string", example="1600 Amphitheatre Parkway, Mountain View, CA")
     *         )
     *     ),
     *     @OA\Response(
     *         response=404,
  ...
  // HERE API incoming parameters
    ...
    /**
     * @OA\Post(
     *     path="/frontend/get-location",
     *     summary="Get address from latitude and longitude using HERE API",
     *     tags={"Frontend-Location"},
     *     @OA\RequestBody(
     *         required=true,
     *         @OA\JsonContent(
     *             required={"lat","lon"},
     *             @OA\Property(property="lat", type="number", example=52.5200),
     *             @OA\Property(property="lon", type="number", example=13.4050)
     *         )
     *     ),
     *     @OA\Response(
     *         response=200,
     ...
     *                 @OA\Property(property="label", type="string", example="Invalidenstraße 116, 10115 Berlin, Germany"),
     *                 @OA\Property(property="countryName", type="string", example="Germany")
     *             )
     *         )
     *     ),
     *     @OA\Response(
     *         response=404,
     *         description="Address not found or API failed"
     *     )
     * )
     */
