			...
			->get()
				...
				return [
					...
					return [
						...
						'sku' => $details->sku,
						'vendor_sku' => $firstSupplier->vendor_sku ?? null,
						'price' =>  (float) $firstSupplier->price ?? null,
						"sale_price" => (float) $firstSupplier->sale_price ?? null,
						'total_reviews' => $totalReviews,
						'avg_rating' => $avgRating,
						...
						'images' => $imageUrls,
						"original_price"=>  (float) $firstSupplier->price ?? null,
						'front_sale_price' => (float) $firstSupplier->sale_price ?? null,
						"best_price"=>  (float) $firstSupplier->price ?? null,
						"selling_type"=> $sellingType,
