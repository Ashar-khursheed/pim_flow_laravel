...
class PaymentHistoryController extends Controller
{
	 ...
	 *                 @OA\Property(property="payment_mode", type="string", enum={"Bank Transfer", "Stripe", "Razorpay", "Cash on Delivery", "CC Avenue", "Credit Card", "Debit Card", "Tabby", "Cheque", "Tamara", "Paymob", "COD", "PayPal", "Stax", "Square","NetTerm"}, example="Cash on Delivery"),
	...
	public function store(Request $request)
	{
		try {
			...
			$validated = $request->validate([
				...
				'payment_mode' => 'required|string|in:Credit Card,Debit Card,PayPal,Bank Transfer,Cash on Delivery,Stripe,Razorpay,CC Avenue,Paymob,Stax,Square,Tabby,Cheque,Tamara,COD,NetTerm',
