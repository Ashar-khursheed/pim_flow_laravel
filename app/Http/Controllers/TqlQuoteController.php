...
class TqlQuoteController extends Controller
{
     ...
     *                 @OA\Property(property="contactExtension", type="string"),
     *                 @OA\Property(property="hoursOpen", type="string", example="valid times include “12:00 PM” and “1:00 AM”."),
     *                 @OA\Property(property="hoursClosed", type="string", example="valid times include “12:00 PM” and “1:00 AM”."),
     *                 @OA\Property(property="puNumber", type="string" )
     *             ),
     ...
     *                 @OA\Property(property="hoursOpen", type="string", example="valid times include “12:00 PM” and “1:00 AM”."),
     *                 @OA\Property(property="hoursClosed", type="string", example="valid times include “12:00 PM” and “1:00 AM”."),
     *                 @OA\Property(property="deliveryPO", type="string" )
     *             ),
     *             @OA\Property(property="accessorials", type="array", @OA\Items(type="string",enum={"INPU"}, example="INPU=>Pickup – Inside")),
     *             @OA\Property(property="quoteCommodities", type="array",
     *                 @OA\Items(
     *                     type="object",
     *                     @OA\Property(property="freightClassCode", type="string", example="'50', '55', '60', '65', '70', '77.5', '85', '92.5', '100', '110', '125', '150', '175', '200', '250', '300', '400', '500'"),
