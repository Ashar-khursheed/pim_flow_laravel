...
class AppServiceProvider extends ServiceProvider
{
	...
	public function boot(): void
	{
		...
		// Discount::observe(TransactionLogObserver::class);
		// DiscountProduct::observe(TransactionLogObserver::class);
		// Faq::observe(TransactionLogObserver::class);
		// FaqCategory::observe(TransactionLogObserver::class);
		// FlashSale::observe(TransactionLogObserver::class);
